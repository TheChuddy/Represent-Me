            ...
            List {
                Section {
                    ...
                    .sheet(isPresented: $showUserInfoSheet) {
                        _V_UserInfoSheetView(homeLibrary: self.homeLibrary, showSheetView: self.$showUserInfoSheet, nameEntry: self.$nameEntry, streetAddressEntry: self.$streetAddressEntry, cityEntry: self.$cityEntry, zipCodeEntry: self.$zipCodeEntry, region: self.$region, phoneEntry: self.$phoneEntry)
                    }
                    HStack {
