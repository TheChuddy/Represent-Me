    ...
    var body: some View {
        TabView(selection: $selection) {
            ...
            _V_HomeScreenView(homeLibrary: homeLibrary, sortByUpvotes: homeLibrary.getSortingByPopular(), sortByNew: homeLibrary.getSortingByNew(), sortByState: homeLibrary.getSortingByRegion(), region: homeLibrary.getSortRegion())
                ...
                .tag(0)
            _V_SettingsView(homeLibrary: homeLibrary, nameEntry: homeLibrary.getUserName(), streetAddressEntry: homeLibrary.getUserAddress(), cityEntry: homeLibrary.getUserCity(), zipCodeEntry: homeLibrary.getUserCity(), region: homeLibrary.getUserState(), phoneEntry: homeLibrary.getUserPhone())
                .tabItem{
...
//From web tutorial: allows for doing things on startup
